#include "ground_segmentation/travel_awf_node.hpp"
...
Travel::Travel(const rclcpp::NodeOptions &node_options)
  ...
  TravelGroundFilterComponent_ =
      std::make_shared<TravelGroundFilterComponent>();
  TravelGroundFilterComponent_->setParams(
...
void Travel::point_cloud_callback(
  ...
  TravelGroundFilterComponent_->estimateGround(*input_cloud, *ground_cloud,
...
RCLCPP_COMPONENTS_REGISTER_NODE(ground_segmentation::Travel)